...
__all__ = [
    ...
    "add_chapter_stitch", "list_chapter_stitches", "get_chapter_stitch",
    "add_generation_task", "list_generation_tasks", "get_generation_task", "update_generation_task",
    "add_style_preset", "list_style_presets", "get_style_preset", "update_style_preset", "delete_style_preset",
