...
BUILTIN_STEP_REGISTRY = {
    ...
    "asr_result_validate": ("backend.steps.s_asr_result_validate", "S_ASRResultValidate"),
    "srt_to_json": ("backend.steps.s_srt_to_json", "S_SrtToJson"),
    "track_mix": ("backend.steps.s_track_mix", "S_TrackMix"),
